...
void main()
{
	vec3 light_dir = vec3(2.0, 5.0, 1.0);			// Define a light direction
	...
	vec4 ambient = diffuse_colour * 0.1	;	// Define ambient as a darker cversin of the vertex colour
	...
	vec4 specular_colour = vec4(1, 0, 0, 1);	// Bright yellow light
